 ...
 * This file demonstrates how to integrate Edgeiris with a web frontend
 */

// For React/Vue/Angular applications
export class EdgeirisClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EdgeirisClient(provider, contractAddress);
